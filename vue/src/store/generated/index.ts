...
import LemonsuyLemonLemonsuyLemonLemon from './lemonsuy/lemon/lemonsuy.lemon.lemon'
...
export default { 
  LemonsuyLemonLemonsuyLemonLemon: load(LemonsuyLemonLemonsuyLemonLemon, 'lemonsuy.lemon.lemon'),
